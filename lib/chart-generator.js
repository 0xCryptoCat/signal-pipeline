...
try {
  // In Vercel/Lambda, process.cwd() might not be what we expect.
  // We should try to resolve relative to the current file or use a known path structure.
  // However, 'fonts' is at the root of the project.
